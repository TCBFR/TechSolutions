...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h1>Création d'un nouveau PC</h1>
        </div>

        <form method="POST" action="/mes-pcs">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="nom" 
                            name="nom" 
                            placeholder="Ex: PC Développement Logiciel"
                            value="<?= $_POST['nom'] ?? '' ?>"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="service" 
                            name="service" 
                            placeholder="Ex: Développement de logiciel"
                            value="<?= $_POST['service'] ?? '' ?>"
                            required
                        >
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            id="description" 
                            name="description" 
                            placeholder="Décrivez la configuration et son usage..."
            ...
            <div class="composants-section">
                <h2>🔧 Sélectionner les composants</h2>
            ...
            <div class="form-actions">
                <a href="/mes-pcs" class="btn btn-secondary">← Annuler</a>
                <button type="submit" class="btn btn-primary">Créer le PC</button>
            </div>
        </form>
    </div>
</div>
