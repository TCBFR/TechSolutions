...
<div class="main-container">
    ...
    <div class="form-container">
        <div class="form-header">
            ...
            <p>Partagez les dernières nouvelles avec vos utilisateurs</p>
        </div>
        ...
        <form method="POST" action="/actualites/store">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="<?= htmlspecialchars($_SESSION['old']['auteur'] ?? 'Admin') ?>"
                >
            </div>
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    required
                ><?= htmlspecialchars($_SESSION['old']['contenu'] ?? '') ?></textarea>
            </div>
